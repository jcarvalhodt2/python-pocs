...
EI1POD = pyping.ping('ei11.symphony.com')
EI2POD = pyping.ping('ei21.symphony.com')
EI3POD = pyping.ping('ei3.symphony.com')
EI4POD = pyping.ping('ei4.symphony.com')


def ping_function():
    print "Verifying if the destination are reachable"
    if EI1POD.ret_code == 0:
        print "ei1.symphony.com POD success!"
    else:
    ...
    if EI2POD.ret_code == 0:
        print "ei2.symphony.com POD success!"
    else:
    ...
    if EI3POD.ret_code == 0:
        print "ei3.symphony.com POD success!"
    else:
    ...
    if EI4POD.ret_code == 0:
        print "ei4.symphony.com POD success!"
    else:
